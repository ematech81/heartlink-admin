              ...
              <tbody>
                {loading ? (
                  ...
                  <tr key={u._id} className="table-row">
                    ...
                    {/* Status */}
                    <td className="px-4 py-3">
                      <span className={clsx('badge', u.isBanned
                    ...
                    {/* Plan */}
                    <td className="px-4 py-3">
                      <span className={clsx('badge', u.isSubscribed
                        ? 'bg-purple-100 text-purple-700'
                        : u.isBoosted ? 'bg-orange-100 text-orange-700' : 'bg-slate-100 text-slate-500'
                      )}>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-1">
                        ...
                        <button
                          onClick={() => upgradeUser(u)}
                          disabled={actionId === u._id || u.isSubscribed}
                          className="p-1.5 rounded-lg hover:bg-purple-50 text-purple-500 transition-colors disabled:opacity-30"
